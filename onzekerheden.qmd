...
::: {.callout-caution title="Statistische benadering" collapse="true"}
...
Voor het bovenstaande voorbeeld wordt de werkelijke gecombineerde onzekerheid
$$
\Delta y = \sqrt{\left(1\right)^2 + \left(0{,}5\right)^2} = \sqrt{1{,}25} \approx 1{,}12
$$
:::
...
\begin{tikzpicture}[scale=1]
    ...
    \draw[thick] (12.5,0) circle (4.5pt);
...
dus:
$$
y = \dfrac{7{,}5 + 17{,}5}{2} \pm \dfrac{17{,}5 - 7{,}5}{2} = 12{,}5 \pm 5
$$

Bij het berekenen met de lineaire benadering wordt het resultaat geschat op $12 \pm 5$, maar in feite ligt het echte interval tussen $7{,}5$ en $17{,}5$. Dit betekent dat de centrale waarde verschuift van $12$ naar $12{,}5$ omdat de combinatie van onzekerheden niet lineair optreedt: kleine veranderingen in beide grootheden samen veroorzaken een grotere spreiding dan alleen hun afzonderlijke relatieve onzekerheden.


Dit komt doordat termen van hogere orde (zoals kwadraten en producten van $\Delta a$ en $\Delta b$) worden verwaarloosd. 
De benadering is nauwkeurig zolang de relatieve onzekerheden klein blijven:
$$
\frac{\Delta a}{a} \ll 1, \quad \frac{\Delta b}{b} \ll 1
$$
Als vuistregel kan je aannemen dat de relatieve onzekerheden kleiner dan $10\%$ moeten blijven voor betrouwbare resultaten.
:::
...
1. $40 \pm 36\,\text{kg}^2$
2. $17{,}5 \pm 4{,}25\,\text{m}^2$
3. $140 \pm 84\,\text{N}^2$
4. $264 \pm 7{,}5\,\text{L}^2$
5. $3{,}84 \pm 2{,}352\,\text{W}^2$
6. $59{,}76 \pm 27{,}53\,\text{A}^2$

#### Quotiënt van onzekerheden

1. $2 \pm 2\,\text{V}$
2. $3 \pm 1{,}25\,\text{K}$
3. $1{,}509 \pm 0{,}453\,\text{J}$
4. $2{,}083 \pm 0{,}006\,\text{L}$
5. $2{,}333 \pm 0{,}683\,\text{s}$
6. $1{,}5 \pm 0{,}917\,\text{T}$

#### Machten van onzekerheden

1. $25 \pm 20\,\text{kg}^2$
2. $39{,}0625 \pm 31{,}25\,\text{m}^4$
3. $8000 \pm 2400\,\text{N}^3$
4. $35831808 \pm 3135283{,}2\,\text{L}^7$

#### Wortels van onzekerheden

1. $3{,}162 \pm 0{,}316\,\sqrt{\text{V}}$
2. $1{,}861 \pm 0{,}078\,\sqrt[4]{\text{K}}$
3. $1{,}516 \pm 2\%\,\sqrt[5]{\text{J}}$
4. $2{,}201 \pm 0{,}0057\%\,\sqrt[7]{\text{L}}$

### Toepassingen (vraagstukken)

1. De oppervlakte van een 2D-plaat is evenredig met $b^2$.  

   Dus de relatieve onzekerheid is:
...
2. De massadichtheid is
   ...
   **Antwoord:** de procentuele onzekerheid van de massadichtheid is **$20\%$**.

3. Het volume van een bol is evenredig met $r^3$, dus de procentuele onzekerheid is driemaal die van de straal/diameter.  

   Het volume van een kubus is evenredig met $z^3$, dus ook daar is de procentuele onzekerheid driemaal die van de zijde.  

   Omdat beide lengtes dezelfde procentuele onzekerheid hebben, is de verhouding:

   $$

   \frac{\%\Delta V_{\text{bol}}}{\%\Delta V_{\text{kubus}}} = 1

   $$

   **Antwoord:** de verhouding is **$1$**.
...
4. Gegeven:
   ...
   \%\Delta a_{\text{max}} = 20\%, \qquad \%\Delta x_0 = 12\%

   $$

   Eerst de relatieve onzekerheid binnen de wortel:
   ...
   Daarna delen door $2$ door de vierkantswortel:

   $$

   \%\Delta k = \frac{32\%}{2} = 16\%

   $$

   **Antwoord:** de onzekerheid van $k$ is **$16\%$**.
