...
::: {.callout-note title="Welk Gen-AI model?"}
...
::: {.callout-tip title="AI, Machine Learning, Deep Learning en Generatieve AI toegelicht"}
{{< video https://youtu.be/qYNweeDHiyU?si=6rDmckRHYTAB1mzL >}}
:::
...
De lagen, bestaande uit neuronen, vormen samen een *neuraal netwerk* (NN). Hoe meer lagen en parameters een netwerk of model heeft, hoe verfijnder de patronen die het kan herkennen en gebruiken. 
